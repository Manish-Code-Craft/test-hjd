              ...
              {testimonial.map((item, index) => (
                <div key={index}>
                  <div className="relative flex flex-col justify-between px-7.5 pt-10 pb-35 md:p-10">
                    <h2 className="text-[24px] chakra sm:text-[40px] md:text-[45px] lg:text-[50px] xl:text-[64px] h-100 xl:h-190 lg:h-180 md:h-200 font-extrabold uppercase leading-[1.8em] tracking-[0.32px] text-white">
                      "{item.text}"
                    </h2>
